...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"]) && !empty($_POST))
{
    ...
    $id="SELECT crop_id,img_url,EngName from vege_name where crop = '$cr'";
    $run = mysqli_query($conn,$id);
    $crres=mysqli_fetch_assoc($run);
    /*.....*/
    /*FETCHING CATOGoRY AND ID*/
    $qctg="SELECT ctg_id , category from category where category LIKE 'vegetables'";
...
Back to Category
 ...
 <span>
    ...
    <button type="button" class="btn btn-info " data-toggle="modal" data-target="#reqcrop" style="position: fixed;top: 80px;right: 0px;" data-placement="bottom" title="பயிர் பெயர் கூடுதலாக சேர்க்க  கோர கிளிக் செய்யவும் ">
Request Crop
</button> </span>
  <div class="btn" style="color: white; position: fixed;top: 80px;right: 900px;"> <a href="add-crop-ctg.php" style="color: white">Back </a></div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="reqcropmes">Add New Vegetable Name</h4>
        </div>
        <div class="modal-body">
          <form method="POST">
            <div class="form-group">
              <label for="recipient-name" class="form-control-label formlabel"><strong>New vegetable Name</strong></label>
              <input type="text" class="form-control" id="reqvege" name="reqvege" />
            </div>
        </div>
    ...
    <!--=================================                     =======================-->
        ...
        <h3 class="center col-sm-12 " style="margin-top: -40px;">Add Crop Form</h3><br>
         ...
         <p class="center col-sm-12 " style="margin-top: -30px;font-size: 25px;">காய்கறிகள்-Vegetables</p> 
  ...
  <!--=====================CROP NAME=========================-->
          ...
          <div class=" center">
             ...
             <strong class="formlabel" style="text-align: center;">Crop Name &nbsp; பயிர் பெயர் *</strong><br>
...
<br>
  <!--=========================================QUANTITY ===================================--> 
          ...
          <div class="row" style="margin-top: -20px;">
            ...
            <strong> <input id="y-qtyy" type="number" class="validate center" value="00" required style="background-color: rgba(242, 242, 242,0.5);" name="y-qty" min="1" max="999999" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" ></strong>
            </div>
