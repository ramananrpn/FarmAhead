...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"]) && !empty($_POST))
{
    ...
    $id="SELECT crop_id,img_url,EngName from rice where crop = '$cr'";
    $run = mysqli_query($conn,$id);
    $crres=mysqli_fetch_assoc($run);
    /*.....*/
    /*FETCHING CATOGoRY AND ID*/
    $qctg="SELECT ctg_id , category from category where category LIKE 'Rice'";
...
<div class="btn" style="color: white; position: fixed;top: 80px;right: 900px;"> <a href="add-crop-ctg.php" style="color: white">Back </a></div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" id="reqcropmes">Add New Rice Name</h4>
        </div>
        <div class="modal-body">
          <form method="POST">
            <div class="form-group">
              <label for="recipient-name" class="form-control-label formlabel"><strong>New Rice Name</strong></label>
              <input type="text" class="form-control" id="reqrice" name="reqrice" />
            </div>
        </div>
    ...
    <!--=================================                     =======================-->
        ...
        <h3 class="center col-sm-12 " style="margin-top: -40px;">Add Crop Form</h3><br>
         ...
         <p class="center col-sm-12 " style="margin-top: -30px;font-size: 25px;">அரிசி
-Rice</p> 
