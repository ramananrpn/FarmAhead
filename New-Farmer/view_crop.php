  ...
  <div  id="menu">
   ...
   echo "<br>";
      ...
      <a class="waves-effect waves-light btn-large" href="add-crop-ctg.php">Add Crops</a>
       <a class="waves-effect waves-light btn-large disabled" href="view_crop.php">View your Crops</a>
   ...
   $sltcrop=mysqli_query($conn,"SELECT * from f_crops_stock where farmer_id = '".$_SESSION['f_id']."'");
     // $sel = "SELECT * from f_crops_stock where farmer_id = '".$_SESSION['f_id']."'";
                      ...
                      if (this.readyState == 4 && this.status == 200) 
                       ...
                       var data= JSON.parse(xmlhttp.responseText);
                        //document.getElementById("abc").innerHTML = data.crop_name;
							...
							document.getElementById("modal_av_qty").value = data.yield_qty_unit;
							document.getElementById("modal_ep_qty").value = data.exp_price_unit;
							document.getElementById("org").value=data.organic;
							var a=document.getElementById("org").value;
							if(a=="Yes")
								document.getElementById("org").checked="checked";
...
<div class="modal fade" id="crop-alter" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="background-color:rgba(242, 242, 242,0.1)">
    <div class="modal-dialog cascading-modal" role="document">
        ...
        <div class="modal-content">
            ...
            <form id="modal_alter_form" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
               <input type="hidden" name="modal_id" id="modal_id" >
               <div class="row" style="">
                <div class="md-form form-sm col m5 s5 ">
                    


                    <input type="number" id="modal_qty"  name="modal_qty" class="form-control " value="0" style="font-size: 17px;" min="1" max="999999" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" required>
                    <label for="modal_qty" style="font-size: 15px;">Available Quantity</label>
                </div>per

                <div class="md-form form-sm col m2 s2 ">
                  <select class="browser-default" id="modal_av_qty" required name="modal_av_qty"  >
                              <
                ...
                <div class="md-form form-sm col m5 s5 ">
                    ...
                    <input type="number" id="modal_ep"  name="modal_ep" class="form-control " value="0" style="font-size: 17px;" min="1" max="999999" onkeypress="return isNumeric(event)" oninput="maxLengthCheck(this)" required>
                    <label for="modal_qty" style="font-size: 15px;">Expected Price</label>
                </div>per

                <div class="md-form form-sm col m2 s2 ">
                  <select class="browser-default" id="modal_ep_qty" required name="modal_ep_qty"  >
                ...
                <div class="md-form form-sm">
                    ...
                    <textarea type="text" id="modal_desc" name="modal_desc" class="form-control" style="font-size: 15px;" value="">a</textarea>
                    <label for="modal_desc" style="font-size: 15px;">Description</label>
                </div>

                 <div class="md-form form-sm">
                  <div class=" col m3 s3"></div>
                <a class=" " style="text-align: center;">Organic Crop &nbsp; இயற்கை பயிர் *</a>
                         <div class="row center-block" style="" align="center">
                          <div class=" col m3 s3"></div>
                          <div class="switch  col m8 s1" style="text-align: center;">
                            <label class="formlabel" style="color: black;">
                               No / இல்லை
                              <input type="checkbox" name="org" id="org" value="">
...
{
  $qty=$_POST["modal_qty"];
  $a_qty=$_POST["modal_av_qty"];
  $id=$_POST["modal_id"];
  $exp_price=$_POST["modal_ep"];
  $exp_price_qty = $_POST["modal_ep_qty"];
  ...
  $org="No";
  mysqli_query($conn,"SET NAMES utf8;");   
  $update="UPDATE f_crops_stock SET organic='".$org."',yield_qty='".$qty."',yield_qty_unit='".$a_qty."',exp_price='".$exp_price."',exp_price_unit='".$exp_price_qty."',description='".$desc."'WHERE id='".$id."'" ;
